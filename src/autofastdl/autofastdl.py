...
class EventHandler(FileSystemEventHandler):
    ...
    def on_moved(self, event) -> None:  # type: ignore[override]
        ...
        self.CancelPendingCreation(event.src_path)
        sourcepath = self.RemotePath(event.src_path)
        destpath = self.RemotePath(event.dest_path)
        ...
        if event.is_directory:
            ...
            if (
                ...
                or path_is_ignored(event.dest_path)
            ):
                return
